# Add to your local machine with `mcp install r2r/mcp_rag.py -v R2R_API_URL=http://localhost:7272` or so.
...
async def search(query: str) -> str:
    ...
    """
    client = R2RClient("http://155.138.220.75:7272")
...
async def rag(query: str) -> str:
    ...
    Returns:
        A response generated based on relevant context from the knowledge base
    """
    client = R2RClient(base_url="http://155.138.220.75:7272")
